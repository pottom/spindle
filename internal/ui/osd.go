...
// osdFrame draws the box round it, in the record's own accent, given up to the
// screen at the corners.
//
// The same pen as the rule over a table and the bracket beside the artwork —
// see columnRule. At one weight a box is a rectangle drawn on the screen, and
